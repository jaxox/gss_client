...
import { PremiumProgressBar } from '../../../components/controls';
...
export default function Step3Details({ data, onNext, onBack }: Props) {
  ...
  return (
    <>
      <PremiumProgressBar currentStep={3} totalSteps={4} />
      <WizardScreenLayout
        currentStep={3}
        totalSteps={4}
      ...
      >
        ...
        <FormSection title="Event Settings">
          ...
          <HelperText
            type="error"
            visible={touched.capacity && !!capacityError}
          >
            {capacityError}
          </HelperText>
              ...
              <View style={styles.paymentCard}>
                ...
                <View style={styles.paymentMethodsGrid}>
                  ...
                  <TextInput
                    ...
                    onChangeText={value =>
                      updatePaymentMethod('cashapp', value)
                    }
                    mode="outlined"
                    placeholder="$cashtag"
                    dense
