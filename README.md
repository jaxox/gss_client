# GSS Client - Gamified Social Sports Platform

## 🚨 FIRST-TIME AGENT? START HERE

**BEFORE DOING ANYTHING:** Read [`docs/PROJECT-CONTEXT.md`](docs/PROJECT-CONTEXT.md) completely.
...
- **Current Progress:** Check [`docs/sprint-status.yaml`](docs/sprint-status.yaml)

### 🚨 CRITICAL - AGENTS ALWAYS GET THIS WRONG
...
1. **[`docs/PROJECT-CONTEXT.md`](docs/PROJECT-CONTEXT.md)** - 🚨 **MANDATORY READ** - Complete project understanding
2. **[`docs/AGENT-CHECKLIST.md`](docs/AGENT-CHECKLIST.md)** - 🚨 **QUICK REFERENCE** - Prevent common mistakes
3. **[`docs/sprint-status.yaml`](docs/sprint-status.yaml)** - Current development status
4. **[`docs/architecture.md`](docs/architecture.md)** - Frontend architecture decisions
5. **[`docs/shared/`](docs/shared/)** - Backend reference documents (READ-ONLY)
